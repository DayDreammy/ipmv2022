...
![](image/image_SENERPckYg.png)

## 1.3 Image Registration

![](image/image_vltlJtnjwD.png)
...
![计算Harris 响应（设置一个阈值）](image/image_Dg98ZaYSNd.png "计算Harris 响应（设置一个阈值）")
...
![左图，Hamming距离为3](image/image_QCACEaHWlp.png "左图，Hamming距离为3")
