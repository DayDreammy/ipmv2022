...
![](image/image_wUmbJZh0wW.png)

## 1.3 Image Registration

![](image/image_BW68FnpNHT.png)
...
![计算Harris 响应（设置一个阈值）](image/image_S14xCTT955.png "计算Harris 响应（设置一个阈值）")
...
![左图，Hamming距离为3](image/image_EZS7bnsqpJ.png "左图，Hamming距离为3")
