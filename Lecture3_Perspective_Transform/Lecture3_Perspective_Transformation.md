...
![](image/image_kWyCz3Yjue.png)

## 1.4 反对称矩阵

![](image/image_yV-498H8b-.png)
...
![](image/image_E0LHNGCRC9.png)

## 1.６ 坐标变换

### 1.6.1 点的旋转

![](image/image_pr7nwD4i5Y.png)
...
![](image/image_-dfn-rJy_F.png)

附：推导方法2

![](image/image_hY2rNsicfA.png)
...
![相机成像示意图](image/image_KeVdxYurOH.png "相机成像示意图")

![](image/image_TySi0Cn0MN.png)

![](image/image_RgvdHMWlnm.png)
...
![](image/image_-vIhpjR4Jl.png)

![](image/image_3Wq722TJ5a.png)

![](image/image_TZdF_WwX0_.png)

比如这张图，Rtrain 第一行，\[0 0 1] .意思是 camera x axis 是在世界坐标系的z axis 方向。其实第一行就是camera x axis 相对于世界坐标系 x,y,z axis 的方向余弦。

![](image/image_cqj1zKDVGX.png)

![](image/image_5OWyI2_hVy.png)
